...
# static fields
.field private static final wf:Ljava/lang/Object;

.field private static wg:Ljava/util/HashSet;
...
.field private static wh:Lcom/google/android/gms/common/images/ImageManager;

.field private static wi:Lcom/google/android/gms/common/images/ImageManager;
...
.field private final wj:Ljava/util/concurrent/ExecutorService;

.field private final wk:Lcom/google/android/gms/common/images/ImageManager$zzb;

.field private final wl:Lcom/google/android/gms/internal/zzrh;
...
.field private final wo:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->wf:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->wg:Ljava/util/HashSet;
...
.method private constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wj:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wk:Lcom/google/android/gms/common/images/ImageManager$zzb;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/common/images/ImageManager;->zzarj()V

    :cond_0
    :goto_0
    new-instance v0, Lcom/google/android/gms/internal/zzrh;

    invoke-direct {v0}, Lcom/google/android/gms/internal/zzrh;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wl:Lcom/google/android/gms/internal/zzrh;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wm:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wn:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wo:Ljava/util/Map;
...
.method private zza(Lcom/google/android/gms/common/images/zza$zza;)Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wk:Lcom/google/android/gms/common/images/ImageManager$zzb;
...
.method static synthetic zza(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wm:Ljava/util/Map;

    return-object v0
.end method

.method static synthetic zzamh()Ljava/lang/Object;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->wf:Ljava/lang/Object;

    return-object v0
.end method

.method private zzarj()V
    .locals 3
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/images/ImageManager;->wk:Lcom/google/android/gms/common/images/ImageManager$zzb;
...
.method static synthetic zzark()Ljava/util/HashSet;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->wg:Ljava/util/HashSet;
...
.method static synthetic zzc(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/zzrh;
    .locals 1

    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wl:Lcom/google/android/gms/internal/zzrh;
...
.method static synthetic zzd(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wo:Ljava/util/Map;
...
.method static synthetic zze(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wn:Ljava/util/Map;
...
.method static synthetic zzf(Lcom/google/android/gms/common/images/ImageManager;)Ljava/util/concurrent/ExecutorService;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/images/ImageManager;->wj:Ljava/util/concurrent/ExecutorService;
...
.method public static zzg(Landroid/content/Context;Z)Lcom/google/android/gms/common/images/ImageManager;
    ...
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->wi:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->wi:Lcom/google/android/gms/common/images/ImageManager;
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/common/images/ImageManager;->wh:Lcom/google/android/gms/common/images/ImageManager;
    ...
    sput-object v0, Lcom/google/android/gms/common/images/ImageManager;->wh:Lcom/google/android/gms/common/images/ImageManager;
...
.method public loadImage(Landroid/widget/ImageView;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v0, p3}, Lcom/google/android/gms/common/images/zza;->zzfu(I)V

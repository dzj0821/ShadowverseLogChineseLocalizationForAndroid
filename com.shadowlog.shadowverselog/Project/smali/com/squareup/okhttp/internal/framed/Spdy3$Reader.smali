...
.method private readGoAway(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    invoke-static {v3, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    invoke-interface {p1, v2, v0, v3}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->goAway(ILcom/squareup/okhttp/internal/framed/ErrorCode;Lokio/ByteString;)V
...
.method private readRstStream(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    .line 222
    :cond_1
    invoke-interface {p1, v2, v0}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->rstStream(ILcom/squareup/okhttp/internal/framed/ErrorCode;)V
...
.method private readSettings(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    .line 261
    iget-object v9, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->source:Lokio/BufferedSource;
    ...
    invoke-static {v9, v10}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 265
    :cond_0
    new-instance v5, Lcom/squareup/okhttp/internal/framed/Settings;

    invoke-direct {v5}, Lcom/squareup/okhttp/internal/framed/Settings;-><init>()V

    .line 266
    .local v5, "settings":Lcom/squareup/okhttp/internal/framed/Settings;
    const/4 v1, 0x0
    ...
    .line 271
    .local v2, "id":I
    invoke-virtual {v5, v2, v3, v6}, Lcom/squareup/okhttp/internal/framed/Settings;->set(III)Lcom/squareup/okhttp/internal/framed/Settings;
    ...
    :goto_1
    invoke-interface {p1, v0, v5}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->settings(ZLcom/squareup/okhttp/internal/framed/Settings;)V
...
.method private readSynReply(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    invoke-virtual {v0, v4}, Lcom/squareup/okhttp/internal/framed/NameValueBlockReader;->readNameValueBlock(I)Ljava/util/List;
...
.method private readSynStream(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    .line 198
    iget-object v6, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->headerBlockReader:Lcom/squareup/okhttp/internal/framed/NameValueBlockReader;

    add-int/lit8 v9, p3, -0xa

    invoke-virtual {v6, v9}, Lcom/squareup/okhttp/internal/framed/NameValueBlockReader;->readNameValueBlock(I)Ljava/util/List;
...
.method private readWindowUpdate(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    invoke-static {v5, v6}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->ioException(Ljava/lang/String;[Ljava/lang/Object;)Ljava/io/IOException;
    ...
    .line 239
    :cond_1
    invoke-interface {p1, v2, v0, v1}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->windowUpdate(IJ)V
...
.method public nextFrame(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;)Z
    ...
    .line 129
    :try_start_0
    iget-object v11, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->source:Lokio/BufferedSource;
    ...
    .line 149
    :pswitch_1
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readSynStream(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 153
    :pswitch_2
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readSynReply(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 157
    :pswitch_3
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readRstStream(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 161
    :pswitch_4
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readSettings(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 165
    :pswitch_5
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readPing(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 169
    :pswitch_6
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readGoAway(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 173
    :pswitch_7
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readHeaders(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V

    goto :goto_1

    .line 177
    :pswitch_8
    invoke-direct {p0, p1, v2, v4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Reader;->readWindowUpdate(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;II)V
    ...
    invoke-interface {p1, v3, v5, v11, v4}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->data(ZILokio/BufferedSource;I)V

...
.method evictExpiredWorkers()V
    ...
    .prologue
    .line 83
    iget-object v3, p0, Lrx/schedulers/CachedThreadScheduler$CachedWorkerPool;->expiringWorkerQueue:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    check-cast v2, Lrx/schedulers/CachedThreadScheduler$ThreadWorker;

    .line 87
    .local v2, "threadWorker":Lrx/schedulers/CachedThreadScheduler$ThreadWorker;
    invoke-virtual {v2}, Lrx/schedulers/CachedThreadScheduler$ThreadWorker;->getExpirationTime()J
    ...
    .line 89
    invoke-virtual {v2}, Lrx/schedulers/CachedThreadScheduler$ThreadWorker;->unsubscribe()V

    goto :goto_0

    .line 98
    .end local v0    # "currentTimestamp":J
    .end local v2    # "threadWorker":Lrx/schedulers/CachedThreadScheduler$ThreadWorker;
    :cond_1
    return-void
.end method

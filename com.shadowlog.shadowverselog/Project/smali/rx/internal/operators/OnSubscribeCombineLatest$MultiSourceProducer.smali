...
.method public request(J)V
    ...
    invoke-virtual {v6, p1, p2}, Ljava/util/concurrent/atomic/AtomicLong;->getAndAdd(J)J
...
.method tick()V
    ...
    .line 142
    sget-object v3, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceProducer;->WIP:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    .local v0, "emitted":I
    :cond_0
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceProducer;->requested:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 147
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceProducer;->buffer:Lrx/internal/util/RxRingBuffer;
    ...
    invoke-virtual {v3, v1}, Lrx/internal/util/RxRingBuffer;->isCompleted(Ljava/lang/Object;)Z
    ...
    .line 150
    iget-object v3, p0, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceProducer;->child:Lrx/Subscriber;
    ...
    .line 160
    iget-object v4, p0, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceProducer;->subscribers:[Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber;
    ...
    .line 161
    .local v2, "s":Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber;, "Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber<TT;TR;>;"
    int-to-long v6, v0

    invoke-virtual {v2, v6, v7}, Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber;->requestUpTo(J)V
    ...
    .line 152
    .end local v2    # "s":Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber;, "Lrx/internal/operators/OnSubscribeCombineLatest$MultiSourceRequestableSubscriber<TT;TR;>;"
    ...
    invoke-virtual {v3, v1, v4}, Lrx/internal/util/RxRingBuffer;->accept(Ljava/lang/Object;Lrx/Observer;)Z

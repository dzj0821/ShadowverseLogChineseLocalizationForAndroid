...
.method static synthetic access$100(Lrx/internal/operators/OnSubscribeRefCount;)Lrx/Subscription;
    .locals 1
    .param p0, "x0"    # Lrx/internal/operators/OnSubscribeRefCount;

    .prologue
    .line 38
    invoke-direct {p0}, Lrx/internal/operators/OnSubscribeRefCount;->disconnect()Lrx/Subscription;
...
.method static synthetic access$200(Lrx/internal/operators/OnSubscribeRefCount;)Lrx/observables/ConnectableObservable;
    .locals 1
    .param p0, "x0"    # Lrx/internal/operators/OnSubscribeRefCount;
...
.method static synthetic access$300(Lrx/internal/operators/OnSubscribeRefCount;)Ljava/util/concurrent/locks/ReentrantLock;
    .locals 1
    .param p0, "x0"    # Lrx/internal/operators/OnSubscribeRefCount;
...
.method static synthetic access$400(Lrx/internal/operators/OnSubscribeRefCount;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 1
    .param p0, "x0"    # Lrx/internal/operators/OnSubscribeRefCount;
...
.method private disconnect()Lrx/Subscription;
    .locals 1

    .prologue
    .line 120
    .local p0, "this":Lrx/internal/operators/OnSubscribeRefCount;, "Lrx/internal/operators/OnSubscribeRefCount<TT;>;"
    new-instance v0, Lrx/internal/operators/OnSubscribeRefCount$2;

    invoke-direct {v0, p0}, Lrx/internal/operators/OnSubscribeRefCount$2;-><init>(Lrx/internal/operators/OnSubscribeRefCount;)V
...
.method public call(Lrx/Subscriber;)V
    ...
    invoke-virtual {v1, p1}, Lrx/observables/ConnectableObservable;->unsafeSubscribe(Lrx/Subscriber;)Lrx/Subscription;
    :try_end_1

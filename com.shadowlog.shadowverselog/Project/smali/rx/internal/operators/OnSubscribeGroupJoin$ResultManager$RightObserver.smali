...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v7, v6, Lrx/internal/operators/OnSubscribeGroupJoin$ResultManager;->guard:Ljava/lang/Object;
    ...
    iget-object v6, v6, Lrx/internal/operators/OnSubscribeGroupJoin;->rightDuration:Lrx/functions/Func1;

    invoke-interface {v6, p1}, Lrx/functions/Func1;->call(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, v6, v2}, Lrx/internal/operators/OnSubscribeGroupJoin$ResultManager$RightDurationObserver;-><init>(Lrx/internal/operators/OnSubscribeGroupJoin$ResultManager;I)V
    ...
    invoke-virtual {v6, v0}, Lrx/subscriptions/CompositeSubscription;->add(Lrx/Subscription;)V
    ...
    .line 240
    .local v3, "list":Ljava/util/List;, "Ljava/util/List<Lrx/Observer<TT2;>;>;"
    monitor-exit v7
    :try_end_3
    ...
    check-cast v4, Lrx/Observer;

    .line 242
    .local v4, "o":Lrx/Observer;, "Lrx/Observer<TT2;>;"
    ...
    .end local v2    # "id":I
    .end local v3    # "list":Ljava/util/List;, "Ljava/util/List<Lrx/Observer<TT2;>;>;"
    .end local v4    # "o":Lrx/Observer;, "Lrx/Observer<TT2;>;"
    :catch_0
    move-exception v5

    .line 245
    .local v5, "t":Ljava/lang/Throwable;
    invoke-virtual {p0, v5}, Lrx/internal/operators/OnSubscribeGroupJoin$ResultManager$RightObserver;->onError(Ljava/lang/Throwable;)V

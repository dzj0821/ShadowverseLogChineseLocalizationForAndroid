...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v10, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$RightSubscriber;->this$1:Lrx/internal/operators/OnSubscribeJoin$ResultSink;
    ...
    .line 242
    .local v7, "md":Lrx/subscriptions/SerialSubscription;
    iget-object v10, p0, Lrx/internal/operators/OnSubscribeJoin$ResultSink$RightSubscriber;->this$1:Lrx/internal/operators/OnSubscribeJoin$ResultSink;

    iget-object v10, v10, Lrx/internal/operators/OnSubscribeJoin$ResultSink;->group:Lrx/subscriptions/CompositeSubscription;

    invoke-virtual {v10, v7}, Lrx/subscriptions/CompositeSubscription;->add(Lrx/Subscription;)V
    ...
    iget-object v10, v10, Lrx/internal/operators/OnSubscribeJoin;->rightDurationSelector:Lrx/functions/Func1;
    ...
    invoke-direct {v0, p0, v4}, Lrx/internal/operators/OnSubscribeJoin$ResultSink$RightSubscriber$RightDurationSubscriber;-><init>(Lrx/internal/operators/OnSubscribeJoin$ResultSink$RightSubscriber;I)V
    ...
    invoke-virtual {p0, v9}, Lrx/internal/operators/OnSubscribeJoin$ResultSink$RightSubscriber;->onError(Ljava/lang/Throwable;)V
    ...
    .end local v4    # "id":I
    .end local v7    # "md":Lrx/subscriptions/SerialSubscription;
    :catchall_1
    move-exception v10
    ...
    .restart local v7    # "md":Lrx/subscriptions/SerialSubscription;
    :cond_2
    :try_start_5
    monitor-exit v11
    :try_end_5
    ...
    invoke-interface {v11, v6, p1}, Lrx/functions/Func2;->call(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v11, v8}, Lrx/Subscriber;->onNext(Ljava/lang/Object;)V
    :try_end_6
